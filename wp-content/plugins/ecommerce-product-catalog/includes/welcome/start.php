    ...
    <div class="ic-select-mode-container">
        ...
        <div class="about__section has-2-columns">
            <div class="column">
                ...
                <p class="ic-select-mode-button-container">
                    <a class="button-primary"
                       href="<?php echo esc_url( add_query_arg( 'mode', 'store', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>">
            ...
            <div class="column">
                ...
                <p class="ic-select-mode-button-container">
                    <a class="button-primary"
                       href="<?php echo esc_url( add_query_arg( 'mode', 'inquiry', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>">
        ...
        <div class="about__section has-2-columns has-subtle-background-color">
            <div class="column">
                ...
                <p class="ic-select-mode-button-container">
                    <a class="button-primary"
                       href="<?php echo esc_url( add_query_arg( 'mode', 'affiliate', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>">
            ...
            <div class="column">
                ...
                <p class="ic-select-mode-button-container">
                    <a class="button-primary"
                       href="<?php echo esc_url( add_query_arg( 'mode', 'simple', admin_url( 'edit.php?post_type=al_product&page=implecode_welcome' ) ) ) ?>">
