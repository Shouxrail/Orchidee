...
class ic_register_product {
	...
	function __construct() {
		...
		add_filter( 'use_block_editor_for_post_type', array( $this, 'can_gutenberg' ), 99, 2 );
		add_filter( 'gutenberg_can_edit_post_type', array( $this, 'can_gutenberg' ), 99, 2 );
		add_filter( 'use_block_editor_for_post', array( $this, 'can_gutenberg' ), 99, 2 );
		add_filter( 'gutenberg_can_edit_post', array( $this, 'can_gutenberg' ), 99, 2 );
