    ...
    public function get_notice_data($type = 'banner') {
        if ($type == 'banner') {
            return array(
                ...
                // array(
                //     'start' => '17-4-2023', // Date format "d-m-Y" [08-02-2019]
                //     'end' => '27-4-2023',
                //     'type' => 'banner',
                //     'content' => ULTP_URL.'assets/img/eid-banner.jpg',
                //     'force' => true
                // )
            );
        } else {
